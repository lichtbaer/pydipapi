    ...
    try:
        ...
        if protocols:
            ...
            if isinstance(parsed_protocol, dict) and 'parsed' in parsed_protocol:
                ...
                print(f"\nInterventionen:")
                print(f"  Gesamte Interventionen: {interventions.get('total_interventions', 0)}")
                ...
                print(f"\nProzedurale Elemente:")
                print(f"  Hat Unterbrechungen: {procedural.get('has_interruptions', False)}")
                print(f"  Hat Geschäftsordnungsanträge: {procedural.get('has_procedural_motions', False)}")
